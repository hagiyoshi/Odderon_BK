...
void intde(std::function<double(double)> f, double a, double b, double *aw,
	double *i, double *err)
{
...
void intdei(std::function<double(double)> f, double a, double *aw, double *i,
    double *err)
{
    int noff, lenawm, nk, k, j, jtmp, jm, m, klim;
...
void intdeo(std::function<double(double)> f, double a, double omega, double *aw,
    double *i, double *err)
{
